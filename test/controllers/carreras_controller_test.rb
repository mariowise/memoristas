...
class CarrerasControllerTest < ActionController::TestCase
  ...
  test "should create carrera" do
    assert_difference('Carrera.count') do
      post :create, carrera: { coordinador_carrera: @carrera.coordinador_carrera, nombre_carrera: @carrera.nombre_carrera }
    end
  ...
  test "should update carrera" do
    patch :update, id: @carrera, carrera: { coordinador_carrera: @carrera.coordinador_carrera, nombre_carrera: @carrera.nombre_carrera }
    assert_redirected_to carrera_path(assigns(:carrera))
  end
